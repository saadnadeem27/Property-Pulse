  ...
  void loadMockData() {
    ...
    final mockProperties = [
      Property(
        ...
        description: 'Beautiful modern villa with stunning city views and premium amenities.',
        ...
        agent: Agent(
          ...
          phone: '+1-555-0123',
          avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612c601?w=150',
      ...
      Property(
        ...
        description: 'Spacious apartment in the heart of the city with modern amenities.',
